...
const $$AstroComponent60 = createComponent(
  ($$result, $$props, $$slots) => {
    return renderTemplate`${renderComponent($$result, "ReactComponent60Lazy", ReactComponent60Lazy, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/private/tmp/astro-hash-change-issue/src/components/react-component-60-lazy.tsx", "client:component-export": "default" })}`;
  },
  "/private/tmp/astro-hash-change-issue/src/components/astro-component-60.astro",
  void 0,
);
...
const file =
  "/private/tmp/astro-hash-change-issue/src/content/docs/reference/example-60.mdx";
const Content = (props = {}) =>
  MDXContent({
    ...props,
