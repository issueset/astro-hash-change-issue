...
import { d as $$CardGrid, e as $$Card } from "./Code-BMXRRrVO.js";
      ...
      createVNode($$CardGrid, {
        ...
        children: [
          createVNode($$Card, {
            ...
            icon: "pencil",
            "set:html":
              '<p>Edit <code dir="auto">src/content/docs/index.mdx</code> to see this page change.</p>',
          }),
          createVNode($$Card, {
            title: "Change page layout",
            icon: "document",
            "set:html":
              '<p>Delete <code dir="auto">template: splash</code> in <code dir="auto">src/content/docs/index.mdx</code> to display a\nsidebar on this page.</p>',
          }),
          createVNode($$Card, {
            title: "Add new content",
            icon: "add-document",
            "set:html":
              '<p>Add Markdown or MDX files to <code dir="auto">src/content/docs</code> to create new pages.</p>',
          }),
          createVNode($$Card, {
            title: "Configure your site",
            icon: "setting",
            "set:html":
              '<p>Edit your <code dir="auto">sidebar</code> and other config in <code dir="auto">astro.config.mjs</code>.</p>',
          }),
          createVNode($$Card, {
            title: "Read the docs",
            icon: "open-book",
            "set:html":
              '<p>Learn more in <a href="https://starlight.astro.build/">the Starlight Docs</a>.</p>',
          }),
        ],
      }),
    ],
...
const file = "/private/tmp/astro-hash-change-issue/src/content/docs/index.mdx";
const Content = (props = {}) =>
  MDXContent({
    ...props,
...
Content.moduleId =
  "/private/tmp/astro-hash-change-issue/src/content/docs/index.mdx";
