...
const $$AstroComponent15 = createComponent(
  ($$result, $$props, $$slots) => {
    return renderTemplate`${renderComponent($$result, "ReactComponent15Lazy", ReactComponent15Lazy, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/private/tmp/astro-hash-change-issue/src/components/react-component-15-lazy.tsx", "client:component-export": "default" })}`;
  },
  "/private/tmp/astro-hash-change-issue/src/components/astro-component-15.astro",
  void 0,
);
...
const file =
  "/private/tmp/astro-hash-change-issue/src/content/docs/reference/example-15.mdx";
const Content = (props = {}) =>
  MDXContent({
    ...props,
