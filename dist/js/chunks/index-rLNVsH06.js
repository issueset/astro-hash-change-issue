...
function applyDefaultProps(codeBlock, config) {
  ...
  const undefinedValueKeys = defaultKeys.filter(
    (key) => codeBlock.props[key] === void 0,
  );
  Object.assign(
    codeBlock.props,
    Object.fromEntries(
...
var github_dark_default = Object.freeze(
  JSON.parse(
...
var github_light_default = Object.freeze(
  JSON.parse(
...
function resolveStyleSettings({
  ...
  const preventUnitlessValues = new Set(
  ...
  constructor(config) {
    ...
    this.themes = Array.isArray(config.themes)
      ...
      : config.themes
        ? [config.themes]
        : [
            new ExpressiveCodeTheme(github_dark_default),
            new ExpressiveCodeTheme(github_light_default),
          ];
...
var framesStyleSettings = new PluginStyleSettings({
  ...
  preventUnitlessValues: [
    "frames.editorActiveTabIndicatorHeight",
    "frames.editorTabBorderRadius",
  ],
});
...
var textMarkersStyleSettings = new PluginStyleSettings({
  ...
  preventUnitlessValues: [
    "textMarkers.lineMarkerLabelPaddingInline",
    "textMarkers.lineMarkerAccentWidth",
  ],
});
...
export {
  ...
  toHexColor as G,
  validateExpressiveCodeAnnotation as H,
  ...
  pluginFrames as b,
  ExpressiveCodeAnnotation as c,
  ExpressiveCodeBlock as d,
  ExpressiveCodeLine as e,
  LanguagesWithFencedFrontmatter as f,
  ...
  codeLineClass as l,
  createInlineSvgUrl as m,
  darken as n,
  ensureColorContrastOnBackground as o,
  pluginTextMarkers as p,
  getCssVarName as q,
  ...
  multiplyAlpha as w,
  onBackground as x,
  pluginFramesTexts as y,
  resolveStyleVariants as z,
};
