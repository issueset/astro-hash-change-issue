...
const $$AstroComponent49 = createComponent(
  ($$result, $$props, $$slots) => {
    return renderTemplate`${renderComponent($$result, "ReactComponent49Lazy", ReactComponent49Lazy, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/private/tmp/astro-hash-change-issue/src/components/react-component-49-lazy.tsx", "client:component-export": "default" })}`;
  },
  "/private/tmp/astro-hash-change-issue/src/components/astro-component-49.astro",
  void 0,
);
...
const file =
  "/private/tmp/astro-hash-change-issue/src/content/docs/reference/example-49.mdx";
const Content = (props = {}) =>
  MDXContent({
    ...props,
