...
const $$AstroComponent03 = createComponent(
  ($$result, $$props, $$slots) => {
    return renderTemplate`${renderComponent($$result, "ReactComponent03Lazy", ReactComponent03Lazy, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/private/tmp/astro-hash-change-issue/src/components/react-component-03-lazy.tsx", "client:component-export": "default" })}`;
  },
  "/private/tmp/astro-hash-change-issue/src/components/astro-component-03.astro",
  void 0,
);
...
const file =
  "/private/tmp/astro-hash-change-issue/src/content/docs/reference/example-03.mdx";
const Content = (props = {}) =>
  MDXContent({
    ...props,
