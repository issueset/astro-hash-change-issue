...
const $$AstroComponent48 = createComponent(
  ($$result, $$props, $$slots) => {
    return renderTemplate`${renderComponent($$result, "ReactComponent48Lazy", ReactComponent48Lazy, { "client:load": true, "client:component-hydration": "load", "client:component-path": "/private/tmp/astro-hash-change-issue/src/components/react-component-48-lazy.tsx", "client:component-export": "default" })}`;
  },
  "/private/tmp/astro-hash-change-issue/src/components/astro-component-48.astro",
  void 0,
);
...
const file =
  "/private/tmp/astro-hash-change-issue/src/content/docs/reference/example-48.mdx";
const Content = (props = {}) =>
  MDXContent({
    ...props,
