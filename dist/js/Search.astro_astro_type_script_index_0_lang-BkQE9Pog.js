const __vite__mapDeps = (
  ...
  d = m.f ||
    (m.f = [
      "js/chunks/ui-core-mIwU1OG1.js",
      "js/chunks/preload-helper-BlTxHScW.js",
    ]),
) => i.map((i) => d[i]);
import { _ as p } from "./chunks/preload-helper-BlTxHScW.js";
const g = {
  ranking: {
    pageLength: 0.1,
    termFrequency: 0.1,
  ...
  constructor() {
    ...
    (r.addEventListener("click", l),
      ...
      window.addEventListener("keydown", (e) => {
        (e.metaKey === !0 || e.ctrlKey === !0) &&
          e.key === "k" &&
          (o.open ? n() : l(), e.preventDefault());
      }));
    let d = {};
    try {
      d = JSON.parse(this.dataset.translations || "{}");
    } catch {}
    const c =
    ...
    window.addEventListener("DOMContentLoaded", () => {
      (window.requestIdleCallback || ((a) => setTimeout(a, 1)))(async () => {
        const { PagefindUI: a } = await p(
          async () => {
            const { PagefindUI: t } =
              await import("./chunks/ui-core-mIwU1OG1.js");
            return { PagefindUI: t };
          },
          __vite__mapDeps([0, 1]),
        );
        new a({
          ...
          processResult: (t) => {
            ((t.url = c(t.url)),
              (t.sub_results = t.sub_results.map(
                (s) => ((s.url = c(s.url)), s),
              )));
          },
        });
